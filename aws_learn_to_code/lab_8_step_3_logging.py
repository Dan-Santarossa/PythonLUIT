...
if __name__ == "__main__":
    main()
####Verbose logging using debug is good when you are in non-production environments, 
####but you would want to set the default level to warning in production to only 
